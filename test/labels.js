...
describe("Labels", function() {
    it("should generate a generic label", function() {
        ...
        assert('<span class="label label-primary">My Label</span>',fn({type: "primary", text:"My Label"}));
    });
    it("should generate a default label", function() {
        ...
        assert('<span class="label label-default">My Label</span>',fn({ text:"My Label"}));
    });
    it("should generate a primary label", function() {
        ...
        assert('<span class="label label-primary">My Label</span>',fn({text:"My Label"}));
    });
    it("should generate a info label", function() {
        var fn = jade.compileFile(path.join(__dirname, "fixtures/labels","label-info.jade"));
        assert('<span class="label label-info">My Label</span>',fn({text:"My Label"}));
    });
    it("should generate a warning label", function() {
        ...
        assert('<span class="label label-warning">My Label</span>',fn({text:"My Label"}));
    });
    it("should generate a danger label", function() {
        var fn = jade.compileFile(path.join(__dirname, "fixtures/labels","label-danger.jade"));
        assert('<span class="label label-danger">My Label</span>',fn({text:"My Label"}));
    });
    it("should generate a success label", function() {
        ...
        assert('<span class="label label-success">My Label</span>',fn({text:"My Label"}));
    });
});
